...
// 2-pass gaussian blur based on
// https://github.com/GDQuest/godot-shaders/blob/master/godot/Shaders/gaussian_blur.shader
// TODO: change to this algorithm
// https://github.com/GDQuest/godot-shaders/blob/master/godot/Shaders/gaussian_blur_optimized.shader
...
{
  COLOR = enabled
      ? gaussian_blur_pass(TEXTURE_PIXEL_SIZE, TEXTURE, UV, blur_samples) * blur_brightness
      : texture(TEXTURE, UV);
}
